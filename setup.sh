...
echo ""
echo "📚 Next steps:"
echo "   1. Update worker/.env with your DETECTION_API_KEY and DETECTION_MODEL"
echo "   2. Run 'bun run dev' to start all services"
echo "   3. Visit https://localhost:5173/ for the app (via Caddy)"
echo "   4. Visit https://localhost:5173/api/ for API documentation"
