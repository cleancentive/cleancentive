...
Full extraction produces a complete `en.json` mechanically, but **DE and FR values are real
...
[docs/domain-glossary.md](docs/domain-glossary.md) with the canonical DE/FR rendering of each domain
